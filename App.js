  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.greeting}>Hello, I'm Tevfik Ozlen!</Text>
        <Text style={styles.info}>Student ID: n01629359</Text>
        <Text style={styles.info}>Program: 213 - Cross-Platform Mobile Development</Text>
